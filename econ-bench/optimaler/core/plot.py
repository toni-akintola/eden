...
def plot_a_1x2_u(alloc, dir_name):
    ...
    img = ax.imshow(
        alloc[::-1, :, 0], extent=[0, 1, 0, 1], vmin=0.0, vmax=1.0, cmap="YlOrRd"
    )
    ...
    plt.savefig(
        os.path.join(dir_name, "alloc1.png"),
        bbox_inches="tight",
        pad_inches=0.05,
        dpi=200,
    )
    ...
    plt.plot(x, y, linewidth=2, linestyle="--", c="black")
    img = ax.imshow(
        alloc[::-1, :, 1], extent=[0, 1, 0, 1], vmin=0.0, vmax=1.0, cmap="YlOrRd"
    )
    ...
    fig.set_size_inches(4, 3)
    plt.savefig(
        os.path.join(dir_name, "alloc2.png"),
        bbox_inches="tight",
        pad_inches=0.05,
        dpi=200,
    )
