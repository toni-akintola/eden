...
class QueueSimulator:
    ...
    def run_simulation(self, max_time: float) -> SimulationResults:
        ...
        while self.current_time < max_time:
            ...
            # --- 1. Calculate Propensity (Event Rates) ---
            ...
            # Clamp delta_t so we don't exceed max_time
    ...
    def _calculate_final_results(
        ...
        for k, T_k in time_spent_at_k.items():
            if T_k > 0:
                ...
                # However, the user-provided mu_k_fn is assumed to follow the
                # primitive process definition, where mu_k is the *rate* not the throughput.
                # The throughput is min(lambda_eff, mu_k).
